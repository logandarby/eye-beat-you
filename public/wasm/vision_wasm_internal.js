...
var ModuleFactory = (() => {
  ...
  return function (ModuleFactory = {}) {
      ...
      if (!Module._imageConverter) {
        Module._imageConverter = (
          ...
          const imageData = new outputType(
            makeDeepCopy
              ? Module.HEAPU8.slice(binaryPtr, binaryPtr + binarySize)
                  .buffer
    ...
    function JsOnSimpleListenerBool(
      output_stream_name,
      out_data,
      timestamp,
    ) {
    ...
    function JsOnVectorListenerBool(
      output_stream_name,
      out_data,
      timestamp,
    ) {
    ...
    function JsOnSimpleListenerInt(
      output_stream_name,
      out_data,
      timestamp,
    ) {
    ...
    function JsOnVectorListenerInt(
      output_stream_name,
      out_data,
      timestamp,
    ) {
    ...
    function JsOnSimpleListenerDouble(
      output_stream_name,
      out_data,
      timestamp,
    ) {
    ...
    function JsOnVectorListenerDouble(
      output_stream_name,
      out_data,
      timestamp,
    ) {
    ...
    function JsOnSimpleListenerFloat(
      output_stream_name,
      out_data,
      timestamp,
    ) {
    ...
    function JsOnVectorListenerFloat(
      output_stream_name,
      out_data,
      timestamp,
    ) {
    ...
    function JsOnSimpleListenerString(
      output_stream_name,
      out_data,
      timestamp,
    ) {
    ...
    function JsOnVectorListenerString(
      output_stream_name,
      out_data,
      timestamp,
    ) {
    ...
    function webgl_enable_WEBGL_draw_instanced_base_vertex_base_instance(
      ctx,
    ) {
    ...
    function _emscripten_webgl_do_create_context(target, attributes) {
      ...
      var contextAttributes = {
        ...
        powerPreference:
          emscripten_webgl_power_preferences[powerPreference],
    ...
    function _wgpuQueueWriteBuffer(
      ...
      if (isNaN(bufferOffset)) return undefined;
      var queue = WebGPU.mgrQueue.get(queueId);
    ...
    function _wgpuRenderPipelineGetBindGroupLayout(
      pipelineId,
      groupIndex,
    ) {
      var pipeline = WebGPU.mgrRenderPipeline.get(pipelineId);
    ...
    Module["requestAnimationFrame"] =
      function Module_requestAnimationFrame(func) {
    ...
    var wasmImports = {
      nd: HaveOffsetConverter,
      md: JsOnEmptyPacketListener,
      ld: JsOnFloat32ArrayImageListener,
      kd: JsOnFloat32ArrayImageVectorListener,
      Ma: JsOnSimpleListenerBinaryArray,
      jd: JsOnSimpleListenerBool,
      id: JsOnSimpleListenerDouble,
      hd: JsOnSimpleListenerFloat,
      gd: JsOnSimpleListenerInt,
      fd: JsOnSimpleListenerString,
      ed: JsOnUint8ArrayImageListener,
      dd: JsOnUint8ArrayImageVectorListener,
      K: JsOnVectorFinishedListener,
      cd: JsOnVectorListenerBool,
      bd: JsOnVectorListenerDouble,
      ad: JsOnVectorListenerFloat,
      $c: JsOnVectorListenerInt,
      _c: JsOnVectorListenerProto,
      Zc: JsOnVectorListenerString,
      ...
      Mc: __embind_register_bool,
      Lc: __embind_register_emval,
      ...
      Cc: __tzset_js,
      a: _abort,
      Bc: custom_emscripten_dbgn,
      D: _emscripten_asm_const_int,
      Ac: _emscripten_date_now,
      Ba: _emscripten_err,
      zc: _emscripten_errn,
      yc: _emscripten_get_heap_max,
      u: _emscripten_get_now,
      xc: _emscripten_memcpy_big,
      wc: _emscripten_outn,
      vc: _emscripten_pc_get_function,
      uc: _emscripten_resize_heap,
      tc: _emscripten_stack_snapshot,
      sc: _emscripten_stack_unwind_buffer,
      rc: _emscripten_webgl_create_context,
      qc: _emscripten_webgl_destroy_context,
      pc: _emscripten_webgl_get_context_attributes,
      ...
      mc: _emscripten_webgpu_export_bind_group_layout,
      za: _emscripten_webgpu_export_device,
      lc: _emscripten_webgpu_export_sampler,
      kc: _emscripten_webgpu_export_texture,
      ...
      d: _glActiveTexture,
      $: _glAttachShader,
      gc: _glBindAttribLocation,
      e: _glBindBuffer,
      fc: _glBindBufferBase,
      v: _glBindFramebuffer,
      b: _glBindTexture,
      t: _glBindVertexArray,
      xa: _glBlendEquation,
      ec: _glBlendFunc,
      p: _glBufferData,
      z: _glClear,
      ...
      q: _glGetIntegerv,
      cc: _glGetProgramiv,
      bc: _glGetShaderInfoLog,
      ac: _glGetShaderiv,
      F: _glGetString,
      $b: _glGetUniformBlockIndex,
      ...
      ma: _glUniform4fv,
      Wb: _glUniform4iv,
      Vb: _glUniformBlockBinding,
      la: _glUniformMatrix4fv,
      h: _glUseProgram,
      k: _glVertexAttribPointer,
      L: _glViewport,
      Qb: mediapipe_create_utility_canvas2d,
      Pb: _mediapipe_find_canvas_event_target,
      Ob: mediapipe_import_external_texture,
      Nb: _mediapipe_webgl_tex_image_drawable,
      Pc: _proc_exit,
      V: _strftime,
      Mb: _strftime_l,
      Lb: _wgpuBindGroupLayoutRelease,
      Kb: _wgpuBindGroupRelease,
      Jb: _wgpuBufferGetMappedRange,
      Ib: _wgpuBufferReference,
      Hb: _wgpuBufferRelease,
      Gb: _wgpuBufferUnmap,
      Fb: _wgpuCommandBufferRelease,
      Eb: _wgpuCommandEncoderBeginComputePass,
      Db: _wgpuCommandEncoderBeginRenderPass,
      Cb: _wgpuCommandEncoderCopyBufferToTexture,
      Bb: _wgpuCommandEncoderCopyTextureToTexture,
      Ab: _wgpuCommandEncoderFinish,
      zb: _wgpuCommandEncoderRelease,
      yb: _wgpuComputePassEncoderDispatchWorkgroups,
      xb: _wgpuComputePassEncoderEnd,
      wb: _wgpuComputePassEncoderRelease,
      vb: _wgpuComputePassEncoderSetBindGroup,
      ub: _wgpuComputePassEncoderSetPipeline,
      tb: _wgpuComputePipelineGetBindGroupLayout,
      sb: _wgpuComputePipelineRelease,
      rb: _wgpuDeviceCreateBindGroup,
      qb: _wgpuDeviceCreateBuffer,
      pb: _wgpuDeviceCreateCommandEncoder,
      ob: _wgpuDeviceCreateComputePipeline,
      nb: _wgpuDeviceCreateRenderPipeline,
      mb: _wgpuDeviceCreateSampler,
      lb: _wgpuDeviceCreateShaderModule,
      kb: _wgpuDeviceCreateTexture,
      jb: _wgpuDeviceGetQueue,
      ib: _wgpuDeviceReference,
      hb: _wgpuDeviceRelease,
      gb: _wgpuPipelineLayoutRelease,
      fb: _wgpuQuerySetRelease,
      eb: _wgpuQueueRelease,
      db: _wgpuQueueSubmit,
      Rb: _wgpuQueueWriteBuffer,
      cb: _wgpuRenderPassEncoderDraw,
      bb: _wgpuRenderPassEncoderEnd,
      ab: _wgpuRenderPassEncoderRelease,
      $a: _wgpuRenderPassEncoderSetBindGroup,
      _a: _wgpuRenderPassEncoderSetPipeline,
      Za: _wgpuRenderPipelineGetBindGroupLayout,
      Ya: _wgpuRenderPipelineRelease,
      Xa: _wgpuSamplerReference,
      Wa: _wgpuSamplerRelease,
      Va: _wgpuShaderModuleReference,
      Ua: _wgpuShaderModuleRelease,
      ...
      Na: xnnLoadWasmModuleJS,
    };
    var asm = createWasm();
    var ___wasm_call_ctors = function () {
      return (___wasm_call_ctors = Module["asm"]["pd"]).apply(
        null,
        arguments,
      );
    };
    var _free = (Module["_free"] = function () {
      return (_free = Module["_free"] = Module["asm"]["rd"]).apply(
        null,
        arguments,
      );
    });
    var _malloc = (Module["_malloc"] = function () {
      return (_malloc = Module["_malloc"] = Module["asm"]["sd"]).apply(
        null,
        arguments,
      );
    });
    ...
    var _attachImageListener = (Module["_attachImageListener"] =
      function () {
        return (_attachImageListener = Module["_attachImageListener"] =
          Module["asm"]["ud"]).apply(null, arguments);
      });
    var _attachImageVectorListener = (Module[
    ...
    var ___errno_location = function () {
      return (___errno_location = Module["asm"]["xd"]).apply(
        null,
        arguments,
      );
    };
    var _bindTextureToStream = (Module["_bindTextureToStream"] =
      function () {
    ...
    var _addBoundTextureToStream = (Module["_addBoundTextureToStream"] =
      function () {
        return (_addBoundTextureToStream = Module[
    ...
    var _addDoubleToInputStream = (Module["_addDoubleToInputStream"] =
      function () {
        return (_addDoubleToInputStream = Module[
    ...
    var _addIntToInputStream = (Module["_addIntToInputStream"] =
      function () {
    ...
    var _addStringToInputStream = (Module["_addStringToInputStream"] =
      function () {
        return (_addStringToInputStream = Module[
          "_addStringToInputStream"
        ] =
          Module["asm"]["Ed"]).apply(null, arguments);
      });
    var _addFlatHashMapToInputStream = (Module[
    ...
    var _addEmptyPacketToInputStream = (Module[
    ...
    var _addDoubleToInputSidePacket = (Module[
    ...
    var _addFloatToInputSidePacket = (Module[
    ...
    var _addIntToInputSidePacket = (Module["_addIntToInputSidePacket"] =
      function () {
        return (_addIntToInputSidePacket = Module[
          "_addIntToInputSidePacket"
        ] =
          Module["asm"]["Ld"]).apply(null, arguments);
      });
    var _addStringToInputSidePacket = (Module[
    ...
    var _addProtoToInputSidePacket = (Module[
    ...
    var _attachDoubleListener = (Module["_attachDoubleListener"] =
      function () {
        return (_attachDoubleListener = Module["_attachDoubleListener"] =
          Module["asm"]["Qd"]).apply(null, arguments);
      });
    var _attachDoubleVectorListener = (Module[
    ...
    var _attachFloatListener = (Module["_attachFloatListener"] =
      function () {
        return (_attachFloatListener = Module["_attachFloatListener"] =
          Module["asm"]["Sd"]).apply(null, arguments);
      });
    var _attachFloatVectorListener = (Module[
    ...
    var _attachIntVectorListener = (Module["_attachIntVectorListener"] =
      function () {
        return (_attachIntVectorListener = Module[
          "_attachIntVectorListener"
        ] =
          Module["asm"]["Vd"]).apply(null, arguments);
      });
    var _attachStringListener = (Module["_attachStringListener"] =
      function () {
        return (_attachStringListener = Module["_attachStringListener"] =
          Module["asm"]["Wd"]).apply(null, arguments);
      });
    var _attachStringVectorListener = (Module[
    ...
    var _attachProtoVectorListener = (Module[
    ...
    var _pushBinarySubgraph = (Module["_pushBinarySubgraph"] =
      function () {
    ...
    var _processGl = (Module["_processGl"] = function () {
      return (_processGl = Module["_processGl"] =
        Module["asm"]["ee"]).apply(null, arguments);
    });
    var _process = (Module["_process"] = function () {
      return (_process = Module["_process"] = Module["asm"]["fe"]).apply(
        null,
        arguments,
      );
    });
    ...
    var _closeGraph = (Module["_closeGraph"] = function () {
      return (_closeGraph = Module["_closeGraph"] =
    ...
    var ___getTypeName = function () {
      return (___getTypeName = Module["asm"]["le"]).apply(null, arguments);
    };
    ...
    var _emscripten_builtin_memalign = function () {
      return (_emscripten_builtin_memalign = Module["asm"]["ne"]).apply(
        null,
        arguments,
      );
    };
    var _memalign = function () {
      return (_memalign = Module["asm"]["oe"]).apply(null, arguments);
    };
    var stackSave = function () {
      return (stackSave = Module["asm"]["pe"]).apply(null, arguments);
    };
    var stackRestore = function () {
      return (stackRestore = Module["asm"]["qe"]).apply(null, arguments);
    };
    var stackAlloc = function () {
      return (stackAlloc = Module["asm"]["re"]).apply(null, arguments);
    };
    var ___cxa_is_pointer_type = function () {
      return (___cxa_is_pointer_type = Module["asm"]["se"]).apply(
        null,
        arguments,
      );
    };
    var ___start_em_js = (Module["___start_em_js"] = 1180644);
    var ___stop_em_js = (Module["___stop_em_js"] = 1188066);
